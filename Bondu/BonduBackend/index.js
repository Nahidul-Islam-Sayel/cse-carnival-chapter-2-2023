...
const StuentsControlHandler= require('./RouteHandler/StudentsControlHandler')
...
const port = 5000
// database connection
mongoose.connect(`mongodb+srv://sametakbo:sametakbo@cluster0.d8lte.mongodb.net/BonduLU?retryWrites=true&w=majority`)
.then(()=>{
...
app.use('/StudentsHanler', StuentsControlHandler );
