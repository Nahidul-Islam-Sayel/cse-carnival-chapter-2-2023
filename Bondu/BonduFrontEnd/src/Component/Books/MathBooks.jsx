    ...
    return (
        <div>
           { firstChapter && <div class="card">
                ...
                <button onClick={() => { setFirstChapter(true);setSecondChapter(false)}}>পরবর্তী অধ্যায় শিখি</button>
            </div>}
            { secondChapter && <div class="card">
                <div class="card-body mathbook">
                    <h1 className='blod'>সংখ্যা নিয়ে খেলি</h1>
                    <p><span className="blod">বিয়োগ </span>
                        দুইটি সংখা আলাদা  করাকে আমার বিয়োগ বলি। ধর তোমরা দুইজন বন্ধু এক জায়গাতে বেড়াতে
                        গেলে এখন আছো তোমরা দুইজন একজন বন্ধু চলে গেলে হবে একজন<br /> <br />
                        <img src={add} alt="" className='bookimg' /> <br /> <br />
                        <img src={num1} alt="" srcset="" className='bookimg' /> <br /> <br />
                        এখনো যদি আমরা  কিছু ফুল বৃদ্ধি করি তাহলে কি হবে একটু যদি দেখি <br /> <br />
                        <img src={num2} alt="" srcset="" className='bookimg' /> <br /> <br />
